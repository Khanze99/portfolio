"""
Django settings for khnz project.
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-*-#lg(q9avkwc9l7rww8bu&+0(gpa5alh)p&x_xpg&z#n22ajq')
...
WSGI_APPLICATION = 'khnz.wsgi.application'
